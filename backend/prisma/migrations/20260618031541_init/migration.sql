...
-- CreateEnum
CREATE TYPE "WalletTxType" AS ENUM ('TOPUP', 'PAYMENT', 'REFUND', 'EARNING', 'REVERSAL');
...
-- AddForeignKey
ALTER TABLE "Wallet" ADD CONSTRAINT "Wallet_buyerId_fkey" FOREIGN KEY ("buyerId") REFERENCES "Buyer"("id") ON DELETE CASCADE ON UPDATE CASCADE;
