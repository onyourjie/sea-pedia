              ...
              <tbody>
                {completed.map((o) => (
                  <tr key={o.id} className="border-b border-gray-50 last:border-0">
                    ...
                    <td data-label="Toko" className="py-3 text-gray-700">{o.store.name}</td>
                    <td data-label="Tanggal" className="py-3 text-gray-500 text-xs">{new Date(o.createdAt).toLocaleDateString("id-ID")}</td>
